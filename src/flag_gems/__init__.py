...
_FULL_CONFIG = (
    ...
    ("__rshift__.Tensor_out", __rshift__),
    ...
    ("greater.Tensor_out", greater_out),
    ...
    ("index_fill_.int_Scalar", index_fill_),
    ...
    ("special_logit", special_logit),
    ("special_logit.out", special_logit_out),
